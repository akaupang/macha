...
###############################################################################
# SYSTEM VARIABLES FOR PRIVATE BACKENDS
...
run_u_submenu () {
  echo ""
  echo "Options for MBLs and SBLs"
  echo ""
  echo " 1 : Modify MM input files with MBL customization hooks (Python 3.9)"
  echo " 2 : Create sQM/MM input file for MBLs using SCCDFTB"
  echo " 3 : Create QM/MM input file for MBLs using Q-CHEM"
  echo " 4 : Create (s)QM/MM input file for MBLs with custom input/output"
  echo ""
