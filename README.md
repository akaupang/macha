...
Typical use cases include rerunning CHARMM-GUI scripts[^1] locally (after edits or changes) and setting up water boxes and complexes e.g. for further setup of free energy calculations with **transformato**[^2][^3], starting from PDB files of separate proteins and/or ligands and/or complexes, e.g. from protein data banks such as the [PDBe](https://www.ebi.ac.uk/pdbe/) or the [RCSB PDB](https://www.rcsb.org/). 
